...
gulp.task('vendor_inject', function(){
    var paths = [];
    _.forIn(scripts.chunks, function(chunkScripts, chunkName){
        chunkScripts.forEach(function(script){
            var scriptFileName = config.app + scripts.paths[script];
    ...
    var vendorStream = gulp.src(paths, {read: false});
    var appStream = gulp.src(config.app + 'app/**/*.js').pipe(angularFilesort());

        gulp.src(config.app + 'index.html')
          .pipe(inject(es.merge(vendorStream, appStream), {relative: true}))
          .pipe(gulp.dest(config.app));
...
//  runSequence(['js', 'wiredep:app', 'ngconstant:dev'], 'languages');
//    runSequence(['js', 'wiredep', 'ngconstant:dev'], 'languages', 'inject');
   runSequence(['js', 'ngconstant:dev'], 'languages', 'vendor_inject');
});
...
gulp.task('build', ['clean'], function (cb) {
  runSequence(['copy', 'wiredep:app', 'ngconstant:prod', 'languages'], 'assets:prod', cb);
//    runSequence(['copy', 'wiredep:app', 'ngconstant:prod', 'languages'], 'vendor_inject', 'assets:prod', cb);
});
